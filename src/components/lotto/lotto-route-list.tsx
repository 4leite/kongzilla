...
import { LottoRouteRow } from 'components/lotto/lotto-route-row'
import { useStoreState, useStoreActions } from 'store'
import { LottoRouteDefinition } from 'model/lotto-routes'
...
export const LottoRouteList: React.FC = () => {
	...
	const enableRoute = async (route: LottoRouteDefinition) => {
		...
		setDisabledRoutes(disabledRoutes.filter((r: LottoRouteDefinition) => r.key !== route.key))
	}
